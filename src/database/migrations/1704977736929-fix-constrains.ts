...
export class FixConstrains1704977736929 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "hotel" ("id" SERIAL NOT NULL, "hotelName" character varying NOT NULL, "address" character varying NOT NULL, "city" character varying NOT NULL, "state" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_3a62ac86b369b36c1a297e9ab26" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."service_type_enum" AS ENUM('flight', 'hotel', 'transportation')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "package" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, "description" character varying, "price" double precision, "savings" double precision, "isOffer" boolean DEFAULT false, "destination" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "wholesalerId" integer, CONSTRAINT "unique_name" UNIQUE ("name"), CONSTRAINT "UQ_b23e12326a4218d09bd72301aa1" UNIQUE ("name"), CONSTRAINT "PK_308364c66df656295bc4ec467c2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "service" ADD CONSTRAINT "FK_3de0b4ddb9fbbd401a1cd2fd2fd" FOREIGN KEY ("hotelId") REFERENCES "hotel"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service" DROP CONSTRAINT "FK_3de0b4ddb9fbbd401a1cd2fd2fd"`,
    );
    await queryRunner.query(
